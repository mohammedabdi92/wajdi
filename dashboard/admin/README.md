...
return [
    ...
    'aliases' => [
        '@dashboard/admin' => 'path/to/your/extracted',
        // for example: '@dashboard/admin' => '@app/extensions/dashboard/yii2-admin-2.0.0',
        ...
    ]
];
```
...
```
yii migrate --migrationPath=@dashboard/admin/migrations
```
