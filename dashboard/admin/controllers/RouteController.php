...
use Yii;
use dashboard\admin\models\Route;
use dashboard\admin\components\MenuHelper;
use yii\caching\TagDependency;
use yii\web\Response;
use dashboard\admin\components\RouteRule;
    ...
    public function behaviors()
    {
        return [
            ...
            'access' => [
                ...
                //],
                'only' => ['search','index','assign','create','getAppRoutes'],
                'rules' => [
                    [
                        'actions' => ['search','index','assign','create','getAppRoutes' ],
                        'allow' => true,
                        'roles' => [
                            'Admin',
                        ],
                    ...
                    [
                        'actions' => ['search','assign','create','index','getAppRoutes'],
                        'allow' => false,
                        'roles' => ['?'],
                    ],
                ],
