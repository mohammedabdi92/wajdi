...
<table width="100%" cellpadding="5" cellspacing="0" border="1" dir="rtl">
   ...
   <?php foreach ($products as $product) : ?>
    ...
    <?php if(!empty($model->total_price_discount_product)): ?>
        <tr bgcolor="#eee">
            <td colspan="3" align="right"><b> مجموع الخصم</b></td>
            <td align="center"><b><?=$model->total_price_discount_product ?></b></td>
        </tr>
    <?php endif;?>
    <?php if(!empty($model->debt)): ?>
        <tr bgcolor="#eee">
            <td colspan="3" align="right"><b> الدين</b></td>
    ...
    <?php if(!empty($model->debt)): ?>
        <tr bgcolor="#eee">
            <td colspan="3" align="right"><b> القيمة الدين</b></td>
            <td align="center"><b><?=$model->debt ?></b></td>
        </tr>
        <tr bgcolor="#eee">
    ...
    <?php endif;?>
    <?php if(!empty($model->total_amount)): ?>
        <tr bgcolor="#eee">
            <td colspan="3" align="right"><b> القيمة المدفوعة</b></td>
            <td align="center"><b><?=$model->total_amount ?></b></td>
        </tr>
    <?php endif;?>
