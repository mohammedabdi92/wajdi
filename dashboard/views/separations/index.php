...
/** @var common\models\SeparationsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'فرط وتجميع المواد';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="separations-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('انشاء طلب', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'urlCreator' => function ($action, \common\models\Separations $model, $key, $index, $column) {
