...
/**
 * FkInventoryOrderSearch represents the model behind the search form of `common\models\FkInventoryOrder`.
 */
class FkInventoryOrderSearch extends FkInventoryOrder
{
    public $product_id;
    ...
    public function search($params)
    {
        ...
        if($this->product_id)
        {
            $query->andWhere(' 1 = (select count(*) from fk_inventory_order_product  where fk_inventory_order_product.inventory_order_id = fk_inventory_order.id  and fk_inventory_order_product.product_id = '.$this->product_id.' limit 1  )');
