 ...
 */
class FkInventoryOrderProduct extends \common\components\BaseModel
{
    ...
    {
        return 'fk_inventory_order_product';
    }
    ...
    {
        return $this->hasOne(FkInventoryOrder::className(), ['id' => 'inventory_order_id']);
    }
