...
class InventoryOrder extends \common\components\BaseModel
{
    ...
    public function rules()
    {
        return [
            ...
            [['supplier_name','inventory_order_id','inventory_order_date','total_count','phone_number','note','supplier_id','total_cost_without_discount','supplierName','repayment_date'],'safe']
        ];
    }
    ...
    public function beforeSave($insert)
    {
        ...
        if ($this->isAttributeChanged('repayment')) {
            // Set the repayment_date field to the current date and time
            $this->repayment_date = time();
        }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'repayment_date' => Yii::t('app', 'تاريخ السداد'),
