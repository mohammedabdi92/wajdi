 ...
 * @property int|null $cost_value_time
 ...
 */
class Damaged extends \common\components\BaseModel
{
    public $store_id;
   ...
   public function rules()
    {
        return [
            ...
            [['cost_value', 'total_amount', 'status_note_id', 'supplyer_pay_amount', 'supplyer_price', 'supplyer_total_amount','cost_value_time'], 'safe'],
    ...
    public function beforeSave($insert)
    {
        ...
        if ($this->isAttributeChanged('cost_value')) {
            // Set the repayment_date field to the current date and time
            $this->cost_value_time = time();
        }
